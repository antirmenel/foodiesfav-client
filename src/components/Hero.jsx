    ...
    >
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            Our carefully curated selection of recipes includes a wide range of
            options to suit any taste, dietary requirement, or cooking skill
            level. With our easy-to-follow instructions and helpful tips, you
            can feel confident in the kitchen and elevate your cooking game.
            <br />
            Explore new ingredients, learn new techniques, and discover new
            flavors with our extensive recipe collection.
            <br />
            So come and join us on a culinary journey around the world, and let
            our recipes inspire you to create delicious meals that will impress
